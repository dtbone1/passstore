...
public class UserDaoTest {
	...
	private Store_Type store_type3 = new Store_Type(3,"Applications");
	private Store_Type store_type4 = new Store_Type(4,"Credit Cards");
	private Store_Type store_type5 = new Store_Type(5,"Email Accounts");
	private Store_Type store_type6 = new Store_Type(6,"Game Accounts");
	private Store_Type store_type7 = new Store_Type(7,"Instant Messengers");
	...
	public void testUserExists(){
		...
		store_TypeDao.createStore_Type(store_type3);
		store_TypeDao.createStore_Type(store_type4);
		store_TypeDao.createStore_Type(store_type5);
		store_TypeDao.createStore_Type(store_type6);
		store_TypeDao.createStore_Type(store_type7);
		userDao.create(user1);
		userDao.create(user2);
		userDao.create(user3);
	...
	public void testStore_TypeCreateRetrieve(){
		...
		assertEquals("Two Store Types should have been created and retrieved.", 7, store_Types1.size());
